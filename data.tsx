...
export const TRANSLATIONS = {
    tr: {
        ...
        ttsSettingDesc: "Soruları ve şıkları Robo Asistan ile sesli oku.",
    ...
    en: {
        ...
        ttsSettingDesc: "Read questions and options aloud with Robo Assistant.",
